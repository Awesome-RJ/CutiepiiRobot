...
from CutiepiiRobot.modules.sql.clear_cmd_sql import get_clearcmd
from CutiepiiRobot import dispatcher, OWNER_ID, EVENT_LOGS, SUDO_USERS, SUPPORT_USERS
...
from CutiepiiRobot.modules.helper_funcs.misc import delete
