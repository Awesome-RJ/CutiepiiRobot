        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                bot.send_message(chat.id,
                               text="OwO My Darling Just Joind This Sexy Chat!",
                               reply_to_message_id=reply,
                               )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                bot.send_message(chat.id,
                               text="Oh My, Heart Doctor Joind This Group.",
                               reply_to_message_id=reply,
                               )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                bot.send_message(chat.id,
                                text="Beware! A Dragons just Joined the group!!",
                                reply_to_message_id=reply,
                               )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                bot.send_message(chat.id,
                                text="Oof! A Demons just joined the group",
                                reply_to_message_id=reply,
                               )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Tigers
                ...
                bot.send_message(chat.id,
                               text="Shinzou Sasageyo! A Tigers just joined the group!",
                               reply_to_message_id=reply,
                               )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
...
CAPTCHA_BUTTON_VERIFY_HANDLER = CallbackQueryHandler(user_captcha_button, pattern=r"user_captchajoin_\([\d\-]+,\d+\)_\(\d{4}\)", run_async=True)
