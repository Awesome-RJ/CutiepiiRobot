        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh My Darling Are You Here, Listin Na I Want Somthing.",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A powerful friend of Cutiepii's just joined, Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Cutie Cutie! My Sweetheat Is Here.",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! My baby just joined! Meet All",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "OwO Are You Joined This Group. OP",
                    reply_to_message_id=reply)
                continue
