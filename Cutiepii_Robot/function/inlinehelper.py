...
from Cutiepii_Robot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from Cutiepii_Robot.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[Cutiepii Robot✨](https://t.me/Cutiepii_Robot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
