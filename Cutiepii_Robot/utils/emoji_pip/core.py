...
from Cutiepii_Robot.utils.emoji_pip import unicode_codes
...
def emojize(
    ...
    """Replace emoji names in a string with unicode codes.
        >>> import emoji
        >>> LOGGER.debug(emoji.emojize("Python is fun :thumbsup:", use_aliases=True))
        Python is fun 👍
        >>> LOGGER.debug(emoji.emojize("Python is fun :thumbs_up:"))
        Python is fun 👍
        >>> LOGGER.debug(emoji.emojize("Python is fun __thumbs_up__", delimiters = ("__", "__")))
        Python is fun 👍
        >>> LOGGER.debug(emoji.emojize("Python is fun :red_heart:",variant="text_type"))
        Python is fun ❤
        >>> LOGGER.debug(emoji.emojize("Python is fun :red_heart:",variant="emoji_type"))
...
def demojize(
    ...
    """Replace unicode emoji in a string with emoji shortcodes. Useful for storage.
        ...
        >>> LOGGER.debug(emoji.emojize("Python is fun :thumbs_up:"))
        Python is fun 👍
        >>> LOGGER.debug(emoji.demojize(u"Python is fun 👍"))
        Python is fun :thumbs_up:
        >>> LOGGER.debug(emoji.demojize(u"Unicode is tricky 😯", delimiters=("__", "__")))
