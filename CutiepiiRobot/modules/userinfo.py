...
from CutiepiiRobot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from CutiepiiRobot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
