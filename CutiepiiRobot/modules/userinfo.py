...
from CutiepiiRobot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_USERS,
                          TIGER_USERS, WHITELIST_USERS, INFOPIC, dispatcher, sw)
from CutiepiiRobot.__main__ import STATS, TOKEN, USER_INFO
import CutiepiiRobot.modules.sql.userinfo_sql as sql
from CutiepiiRobot.modules.disable import DisableAbleCommandHandler
from CutiepiiRobot.modules.sql.global_bans_sql import is_user_gbanned
from CutiepiiRobot.modules.sql.afk_sql import is_afk, check_afk_status
from CutiepiiRobot.modules.sql.users_sql import get_user_num_chats
from CutiepiiRobot.modules.sql.feds_sql import get_user_fbanlist
from CutiepiiRobot.modules.helper_funcs.chat_status import sudo_plus
from CutiepiiRobot.modules.helper_funcs.extraction import extract_user
from CutiepiiRobot import telethn as SaitamaTelethonClient, TIGER_USERS, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'Techno Ocean'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/techno_ocean/15">?</a>]'.format(
            bot.username)
