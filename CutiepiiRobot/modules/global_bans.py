...
from CutiepiiRobot.modules.sql.users_sql import get_user_com_chats
import CutiepiiRobot.modules.sql.global_bans_sql as sql
from CutiepiiRobot import (DEV_USERS, EVENT_LOGS, OWNER_ID, STRICT_GBAN,
...
from CutiepiiRobot.modules.helper_funcs.misc import send_to_list
from CutiepiiRobot.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    text = "Malicious: <b>{}</b>"
    if user_id in [777000, 974650192]:
        return ""
