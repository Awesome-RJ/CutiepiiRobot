...
import CutiepiiRobot.modules.sql.notes_sql as sql
from CutiepiiRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from CutiepiiRobot.__main__ import DATA_IMPORT
...
# from CutiepiiRobot.modules.rules import get_rules
import CutiepiiRobot.modules.sql.rules_sql as rulessql

# from CutiepiiRobot.modules.sql import warns_sql as warnssql
import CutiepiiRobot.modules.sql.blacklist_sql as blacklistsql
from CutiepiiRobot.modules.sql import disable_sql as disabledsql

# from CutiepiiRobot.modules.sql import cust_filters_sql as filtersql
# import CutiepiiRobot.modules.sql.welcome_sql as welcsql
import CutiepiiRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("CutiepiiRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("CutiepiiRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `CutiepiiRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("CutiepiiRobot{}.backup".format(chat_id))  # Cleaning file
