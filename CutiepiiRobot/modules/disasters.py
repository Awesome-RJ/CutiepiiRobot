...
from CutiepiiRobot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          TIGERS, WOLVES, dispatcher)
from CutiepiiRobot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'CutiepiiRobot/elevated_users.json')
