...
import CutiepiiRobot.modules.sql.global_bans_sql as gban_sql
import CutiepiiRobot.modules.sql.users_sql as user_sql
from CutiepiiRobot import DEV_USERS, OWNER_ID, dispatcher
